  ...
  const renderOption = option => {
    ...
    return (
      <Grid
        ...
        onClick={() => props.history.push(`/produto?produto=${option.id}`)}
      >
        <Grid container item direction="column" sm={9} xs={9} md={3} lg={3}>
          ...
          >
            <Typography color="textSecondary" variant="subtitle2">
              {UTILS.formatToMaxCaractersAllowed(option.desc_produto, 20)}
            </Typography>
          ...
          >
            <Typography color="textSecondary" variant="body">
              {UTILS.formatToMaxCaractersAllowed(option.desc_cor, 20)}
            </Typography>

            <Typography variant="h6">
              {UTILS.formatToMaxCaractersAllowed(option.cor_produto, 20)}
            </Typography>
          </Grid>
        </Grid>
              ...
              endAdornment: (
                <React.Fragment>
                  <IconButton
                    ...
                    onClick={getAllProductsBasedInInput}
                  >
